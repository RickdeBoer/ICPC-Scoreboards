# ICPC-Scoreboards
This repository contains raw and cleaned scoreboard data for several competitions of the ICPC. Scripts that were used to process the data are also here. 
